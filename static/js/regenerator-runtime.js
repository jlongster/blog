/*
 * I had to copy this to patch the usage of GeneratorFunction.
 * Currently Uglify drops function names on function expressions which
 * is crazy, and regenerator created a function call GeneratorFunction
 * used the `.name` property. I made it a normal declared function to
 * fix it.
 *
 * When Uglify doesn't drop names on function expressions, we can use
 * the normal runtime.
 *
 * - jlongster
 */
